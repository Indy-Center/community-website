/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./src/worker-configuration.d.ts` (hash: 24923af3a88e07aa62277afa24af56f2)
// Runtime types generated with workerd@1.20250917.0 2025-08-30 nodejs_als,nodejs_compat
declare namespace Cloudflare {
	...
	interface Env {
		...
		DISCORD_WEBHOOK_TECH_TEAM_ALERTS: string;
		DISCORD_WEBHOOK_SENIOR_STAFF_ALERTS: string;
		VATUSA_API_KEY: string;
		PUBLIC_CONSOLA_LEVEL: string;
		DB: D1Database;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DB" | "DATABASE_URL" | "CONNECT_CLIENT_ID" | "CONNECT_CLIENT_SECRET" | "CONNECT_BASE_URL" | "CONNECT_CALLBACK_URL" | "DISCORD_WEBHOOK_URL" | "DISCORD_WEBHOOK_TECH_TEAM_ALERTS" | "DISCORD_WEBHOOK_SENIOR_STAFF_ALERTS" | "VATUSA_API_KEY" | "PUBLIC_CONSOLA_LEVEL">> {}
}
